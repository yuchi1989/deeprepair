...
def draw_bias_graph(pretrain, repair, second='bicycle', third='baseball glove'):
    with open("../../exp_4/coco/log/id2object.pickle", "rb") as f:
    ...
    for i in information:
        acc = i["accuracy"]
        nature_accuracy.append(acc)
        bias.append(compute_pairwise_bias(i["confusion"], second, third, id2object))
    ...
    ax.plot(x, nature_accuracy, 'r-', label="mean average precision")
...
if __name__ == '__main__':
    ...
    #top_bias("../../exp_4/coco/log/coco_epoch_confusion.npy", 3000)
    ...
    draw_bias_graph("../../exp_4/coco/log/coco_epoch_confusion.npy", "./log/global_epoch_confusion_book_bird.npy", "book", "bird")
...
def main():
    ...
    print('Repair Confusion DBR Best accuracy (top-1 and 5 error):', best_err1, best_err5, file=open("output.txt", "a"))
    ...
    if os.path.isfile(repaired_model):
        ...
        log_print(global_epoch_confusion[-1]
                  ["confusion"][(args.second, args.first)])
    import pickle
    pickle.dump(grads, open(args.gradname , "wb" ))

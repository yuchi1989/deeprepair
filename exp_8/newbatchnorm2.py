    ...
    def forward(self, input):
        ...
        if self.training:
            ...
            if self.debug:
                ...
                print("weighted mean: " + str(original_half.mean([0, 2, 3])) + " * " + str((1 - self.target_ratio)) + str(target_half.mean([0, 2, 3])) + " * " + str(self.target_ratio))
                print(str(exponential_average_factor) + " *  weighted mean + (1 - " + str(exponential_average_factor) +") * previous running mean" )
                print("both forward running mean: " + str(self.running_mean))
            print("------------------------------------------------------")
        else:
